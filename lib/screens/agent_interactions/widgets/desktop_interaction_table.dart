...
//         ...interactionData.map((data) => _buildRow(data, columns)),
//       ],
//     );
//   }
...
//   Widget _buildRow(InteractionData data, List<String> columns) {
//     return Container(
...
//         children: columns.map((column) => _buildCell(column, data)).toList(),
//       ),
//     );
//   }

//   Widget _buildCell(String column, InteractionData data) {
//     switch (column) {
//       case 'lender':
//         return Expanded(
...
//       case 'status':
//         return Expanded(
//           child: LenderStatusBadge(type: data.status),
//         );
//       case 'lastContacted':
//         return Expanded(
//           child: Text(
